...
const mainHeaders = ref([
  { title: '월별', key: 'MONTH_DP', width: '110' },
  { title: '소계', key: 'SUB_TOT_CNT', width: '140', customBodyCellStyle: 'table-body-style-right' },
  { title: '경형', key: 'CAR1_CNT', width: '120', customBodyCellStyle: 'table-body-style-right' },
  { title: '소형', key: 'CAR2_CNT', width: '120', customBodyCellStyle: 'table-body-style-right' },
  { title: '중형', key: 'CAR3_CNT', width: '120', customBodyCellStyle: 'table-body-style-right' },
  { title: '대형', key: 'CAR4_CNT', width: '120', customBodyCellStyle: 'table-body-style-right' },
  { title: '일평균', key: 'DAILY_AVG', width: '90', customBodyCellStyle: 'table-body-style-right' },
]);
...
const handleSearch = async () => {
  try {
    ...
    const response = await request('post', 'api/traffic/getTrafficMonth', {
...
const handlePrint = () => {
  if (mainContents.value.length === 0) {
    ...
    reportRequestData.value = createOzDataset('/TRAFFIC/trafficMonth.ozr', {
